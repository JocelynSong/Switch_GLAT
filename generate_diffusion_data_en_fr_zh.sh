...
model_path=./output
mkdir -p $model_path
remote_model_path=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/songzhenqiao/multilingual_glat/models/multilingual_nat/vanilla_MNAT_en_fr_zh/checkpoint_${src}-${tgt}_best.pt
hadoop fs -get $remote_model_path $model_path


for rate in 0.2 0.3 0.4 0.5; do

remote_path=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/songzhenqiao/multilingual_glat/total_data/wmt_en_fr_zh/nat_diffusion_data/rate${rate}/rank$rank
