...
def main():
    ...
    src_file = "./../../visualization/transformer/transformer.emb.de.txt"
    tar_file = "./../../visualization/transformer/transformer.emb.en.txt"
    ...
    src_emb_dict = load_word_embedding(src_word_file, src_file)
    tgt_emb_dict = load_word_embedding(tar_word_file, tar_file)
