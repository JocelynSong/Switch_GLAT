...
if __name__ == "__main__":
    data_path = "./downstream_tasks/sentence_retrieval"
    embed_path = "./embeds"
    ...
    english_bpe = os.path.join(data_path, "de-en.en.bpe")
    german_bpe = os.path.join(data_path, "de-en.de.bpe")
    ...
    english_bpe = os.path.join(data_path, "fr-en.en.bpe")
    german_bpe = os.path.join(data_path, "fr-en.fr.bpe")
