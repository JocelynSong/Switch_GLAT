...
remote_checkpoint_path=${hdfs_checkpoint_path}/wmt_ten_big_diffusion
mkdir -p ${local_checkpoint_path}
hadoop fs -mkdir -p ${hdfs_checkpoint_path}
hadoop fs -mkdir -p ${remote_checkpoint_path}

# initialize model path
initialized_model_path=${hdfs_checkpoint_path}/wmt_ten_big
...
--vanilla-model-bleu '{"de-en": 28.86, "en-de": 22.37, "ro-en": 35.87, "en-ro": 32.03, "ru-en": 29.27, "en-ru": 24.35, "en-zh": 13.56, "zh-en": 18.04, "en-fr": 28.75, "fr-en": 31.29}' \
