...
@register_task("multilingual_glat_translation", dataclass=MultilingualGlatTranslationConfig)
class MultilingualGlatTranslationTask(TranslationTask):
    ...
    def train_step(self, sample, model, criterion, optimizer, update_num, ignore_grad=False):
        ...
        model.train()
        # print(update_num)
        train_ratio = max(0, min(1, update_num / float(self.cfg.total_sample_updates)))
        sample["glat"] = {"context_p": 0.5 - self.cfg.minus_p * train_ratio}
