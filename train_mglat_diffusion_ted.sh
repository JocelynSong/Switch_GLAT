...
# AT Data Pth
data_path=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/songzhenqiao/multilingual_glat/total_data/ted_three
...
hdfs_checkpoint_path=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/songzhenqiao/multilingual_glat/models/ted_three
remote_checkpoint_path=${hdfs_checkpoint_path}/mglat_diffusion
mkdir -p ${local_checkpoint_path}
hadoop fs -mkdir -p ${hdfs_checkpoint_path}
hadoop fs -mkdir -p ${remote_checkpoint_path}

# initialize model path
initialized_model_path=${hdfs_checkpoint_path}/vanilla_mglat
...
--lgs "en-fr-es-pt" \
--mt-steps "en-fr,fr-en,en-es,es-en,en-pt,pt-en" \
--metric-pair "fr-en" \
--total-sample-updates 300000 \
--minus-p 0.2 \
--dataset-impl "raw" \
...
--vanilla-model-bleu '{"pt-en": 31.44, "en-pt": 23.93, "en-es": 33.05, "es-en": 36.43, "en-fr": 34.44, "fr-en": 36.43}' \
--diffusion-data-path ${diffusion_data_path} \
--diffusion-generation-interval 10 \
--diffusion-interval 5 \
--diffusion-num 300000 \
--diffusion-steps "en-pt-es,es-en-pt,fr-en-es,pt-en-fr" \
